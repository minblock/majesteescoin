# Support for Output Descriptors in Majesteescoin Core

Since Majesteescoin Core v0.17, there is support for Output Descriptors. This is a
...
on Majesteescoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Majesteescoin Core wallets, a convenience function `combo` is
