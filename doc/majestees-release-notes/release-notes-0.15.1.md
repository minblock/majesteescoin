Majesteescoin Core version *0.15.1* is now available from:

  <https://download.majestees.org/majestees-0.15.1/>
...
A number of changes to the way Majesteescoin Core deals with peer connections and invalid blocks
