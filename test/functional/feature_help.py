...
"""Verify that starting majestees with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start majestees with -h for help text")
        ...
        self.log.info("Start majestees with -version for version information")
        ...
        self.log.info("Start majesteesd with -fakearg to make sure it does not start")
