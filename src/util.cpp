...
const char * const BITCOIN_CONF_FILENAME = "majestee.conf";
const char * const BITCOIN_PID_FILENAME = "majestee.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Majestee";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Majestee";
#else
    // Unix
    return pathRet / ".majestee";
#endif
#endif
}
