...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/majestee-project/majestee>";
    const std::string URL_WEBSITE = "<https://majestee.org>";
