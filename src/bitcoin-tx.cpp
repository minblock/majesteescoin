...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " majestees-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  majestees-tx [options] <hex-tx> [commands]  Update hex-encoded majestees transaction\n" +
            "or:     majestees-tx [options] -create [commands]   Create hex-encoded majestees transaction\n" +
            "\n";
