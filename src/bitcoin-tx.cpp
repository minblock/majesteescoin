...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s majestee-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  majestee-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded majestee transaction") + "\n" +
              "  majestee-tx [options] -create [commands]   " + _("Create hex-encoded majestee transaction") + "\n" +
              "\n";
