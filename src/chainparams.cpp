...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1578532664, 756092, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xb68493c0a8856a2bd21d42960238f54734e7f2bdcc159c032451f901090f2847"));
        ...
        //vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-a.majestee.loshan.co.uk", true));
        //vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        //vSeeds.push_back(CDNSSeedData("majesteetools.com", "dnsseed.majesteetools.com"));
        //vSeeds.push_back(CDNSSeedData("majesteepool.org", "dnsseed.majesteepool.org"));
...
public:
    CTestNetParams() {
        ...
        //vSeeds.push_back(CDNSSeedData("majesteetools.com", "testnet-seed.majesteetools.com"));
        //vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.majestee.loshan.co.uk", true));
