...
// Copyright (c) 20020 The Majestees Core developers
...
{
    const char* pszTimestamp = "Provigen Networks is accepting Picscoin 1/8/2020";
...
public:
    CMainParams() {
        ...
        consensus.BIP34Hash = uint256S("80156a555d3e356668997ecf9be63330dbc3284624b51cc0de8ee30224eaa886");
        ...
        consensus.nMinimumChainWork = uint256S("0x000000000000000000000000000000000000000000000000000043948aec46d6");

        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x1d78c633405ffec7d866f2eb13171b87b0a4c715aa78b01dd2f1eec9eeafcaab"); //323813
        ...
        m_assumed_blockchain_size = 0.170;
        m_assumed_chain_state_size = 0.049;

        genesis = CreateGenesisBlock(1580692708, 617793, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x80156a555d3e356668997ecf9be63330dbc3284624b51cc0de8ee30224eaa886"));
        assert(genesis.hashMerkleRoot == uint256S("0xebf591e8092b5988bde1d3766e7d011bed58638086d601c35faeac4c328e0d0e"));
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = {0x4d, 0x61, 0x6a, 0x69};
        base58Prefixes[EXT_SECRET_KEY] = {0x63, 0x6f, 0x69, 0x6e};
        ...
        checkpointData = {
            {
                ...
                {  323813, uint256S("0x1d78c633405ffec7d866f2eb13171b87b0a4c715aa78b01dd2f1eec9eeafcaab")},
            }
        };
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1486949366, 3114320, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xabf0b0c6cbf979d9a94a2b9be24d202eae03e38668b18489ea517936d5a855a5"));
        assert(genesis.hashMerkleRoot == uint256S("0xebf591e8092b5988bde1d3766e7d011bed58638086d601c35faeac4c328e0d0e"));
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xa3d5d93f6854c2078a6ec24d1f854264ad4aa8afbb4932b8cfa3a09651ded17f"));
        assert(genesis.hashMerkleRoot == uint256S("0xebf591e8092b5988bde1d3766e7d011bed58638086d601c35faeac4c328e0d0e"));
